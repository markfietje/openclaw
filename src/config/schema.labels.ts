...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.security.disableLocalhostPrivilege": "Disable Localhost Privilege",
  "gateway.security.strictHeaderValidation": "Strict Header Validation",
  "gateway.security.strictProtoValidation": "Strict Proto Validation",
  "gateway.security.enableMessageAuthorization": "Message Authorization",
  "gateway.security.enableHandshakeTokens": "Handshake Tokens",
  "gateway.security.enableRateLimiting": "Rate Limiting",
  "gateway.security.requireSubprotocol": "Require Subprotocol",
  "gateway.security.validateHostHeader": "Validate Host Header",
  "gateway.security.ipAllowlist": "IP Allowlist",
  "gateway.security.ipBlocklist": "IP Blocklist",
  "gateway.security.rejectUntrustedProxyHeaders": "Reject Untrusted Proxy Headers",
  "gateway.security.autoDisableLocalhostBehindProxy": "Auto-Disable Localhost Behind Proxy",
  "gateway.security.enforceOriginCheckForAllClients": "Enforce Origin for All Clients",
  "gateway.security.maxWebSocketConnections": "Max WebSocket Connections",
  "gateway.security.maxPayloadBytes": "Max Payload Bytes",
  "gateway.security.enablePingPong": "Ping/Pong Keep-Alive",
  "gateway.security.pingIntervalMs": "Ping Interval (ms)",
  "gateway.security.pongTimeoutMs": "Pong Timeout (ms)",
  "gateway.security.connectionRateLimit": "Connection Rate Limit",
  "gateway.security.connectionRateLimit.maxAttempts": "Max Attempts",
  "gateway.security.connectionRateLimit.windowMs": "Window (ms)",
  "gateway.security.connectionRateLimit.lockoutMs": "Lockout (ms)",
  "gateway.security.connectionRateLimit.exemptLoopback": "Exempt Loopback",
  "gateway.security.connectionRateLimit.ipv6SubnetMask": "IPv6 Subnet Mask",
  "gateway.security.dangerouslyAllowHostHeaderOriginFallback":
    "\u26A0\uFE0F Allow Host Header Fallback",
  "gateway.security.dangerouslyAllowLegacyEndpointFallback":
    "\u26A0\uFE0F Allow Legacy Endpoint Fallback",
  "gateway.security.dangerouslyAllowUnmappedMethods": "\u26A0\uFE0F Allow Unmapped Methods",
  "gateway.security.enableToolAudit": "Tool Audit Logging",
  "gateway.security.enableOutboundRedaction": "Outbound Message Redaction",
  "gateway.security.tlsMinVersion": "Minimum TLS Version",
  "gateway.tools.execDenyPathPatterns": "Exec Deny Path Patterns",
  nodeHost: "Node Host",
