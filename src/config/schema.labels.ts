...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.security": "Gateway Pre-Handshake Security",
  "gateway.security.strictHeaderValidation": "Strict Proxy Header Validation",
  "gateway.security.rejectUntrustedProxyHeaders": "Reject Untrusted Proxy Headers",
  "gateway.security.rejectCrossSiteWebSocketRequests": "Reject Cross-Site WebSocket Upgrades",
