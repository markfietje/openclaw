...
const TAG_OVERRIDES: Record<string, ConfigTag[]> = {
  ...
  "gateway.security": ["security", "network", "advanced"],
  "gateway.security.strictHeaderValidation": ["security", "network", "advanced"],
  "gateway.security.rejectUntrustedProxyHeaders": ["security", "network", "advanced"],
  "gateway.security.rejectCrossSiteWebSocketRequests": ["security", "network", "advanced"],
