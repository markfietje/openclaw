...
// IP resolution primitives live in the shared package so cross-package
// consumers (gateway-client, rate limiters) get the same canonical behavior.
// Re-export from here for back-compat with the rest of `src/gateway/`.
import {
  isLoopbackAddress,
